    ...
    >
      ...
      <div className="p-6 space-y-4">
        ...
        <div className="flex items-center justify-between pt-2">
          ...
          <Link href={link}>
            <button className="flex items-center space-x-2 bg-foreground text-background px-5 py-2.5 rounded-2xl text-[10px] font-black uppercase tracking-widest hover:bg-accent-blue hover:text-white transition-all shadow-lg hover:shadow-accent-blue/20 transform hover:-translate-y-1 active:scale-95">
              <span>Join</span>
              <ArrowRight size={14} />
            </button>
          </Link>
