    ...
    <div className="flex flex-col min-h-screen">
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-12">
            <div className="max-w-xl space-y-6">
              ...
              <div className="flex flex-wrap gap-4 pt-4">
                <button className="px-8 py-3 rounded-xl bg-accent-purple text-white font-bold glow-purple transition-all hover:scale-105 active:scale-95">
                  Design Your Card
                </button>
      ...
      <section className="py-24 relative overflow-hidden">
        ...
        <div className="container mx-auto px-6 text-center space-y-8">
          <h2 className="text-3xl md:text-5xl font-black text-foreground">READY TO DOMINATE?</h2>
          <p className="text-muted-foreground max-w-2xl mx-auto text-lg">
            Join thousands of players already competing in the arena. Your journey to pro starts here.
          </p>
          <button className="px-12 py-5 rounded-2xl bg-foreground text-background font-black text-xl hover:scale-105 transition-all shadow-2xl">
            JOIN MATCHPOINT NOW
          </button>
        </div>
      </section>
