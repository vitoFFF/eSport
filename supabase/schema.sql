...
DROP TABLE IF EXISTS public.rankings, public.media, public.matches, public.tournament_registrations, public.tournaments, public.team_members, public.teams, public.organizations, public.profiles CASCADE;
...
CREATE TABLE public.tournaments (
  ...
  banner_url TEXT,
  settings JSONB DEFAULT '{}', -- colors, fonts, layout
...
CREATE POLICY "Managers can insert their own organizations." ON public.organizations FOR INSERT WITH CHECK (auth.uid() = owner_id);
...
CREATE POLICY "Managers can insert their teams." ON public.teams FOR INSERT WITH CHECK (true); 
